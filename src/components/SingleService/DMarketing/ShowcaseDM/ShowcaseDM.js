...
const ShowcaseDM = () => {
  return (
    ...
    <Zoom left cascade><p className='showcase-content-caption'>Digital Marketing</p></Zoom>
    <Zoom left cascade><p className='showcase-title'>We Provide Digital Marketing using new Technologies.</p></Zoom><br/>
    </div>
